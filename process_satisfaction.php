...
'Comforto_e_Limpeza_dos_Quartos','Pequeno-Almoço','Envolvente_externo_ao_empreendimento','Internet','Acessibilidade_ao_empreendimento','Acessibilidade_a_Ilha','geral','mensagem'];
    ...
    try {
        ...
        $message = Swift_Message::newInstance()
           ...
           ->setFrom($email);
            ...
            $image_ilha = $message->embed(Swift_Image::fromPath('assets/images/Sao vicente Logo.png'));
            $image_logo = $message->embed(Swift_Image::fromPath('assets/images/logo.png'));
...
<title>Chez Loutcha Residencial</title>
</head>
...
<tr>
<td style="text-align:center;padding:2em; width: 100px;"><img src="$image_logo" style='width: 150px;'></td>
</tr>
<tr>
<td style="padding-top: 0.5em">
<h1 style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', Verdana, sans-serif; color: #0E618C; text-align:
center">Chez Loutcha Residencial</h1>
</td>
</tr>
<tr>
...
EOT;
        ...
        $html .= '</ul></td></tr>';
        $html .="<tr>
                <td style='text-align:center'><img src='$image_ilha' style='width: 150px;'s></td>
                </tr>";
